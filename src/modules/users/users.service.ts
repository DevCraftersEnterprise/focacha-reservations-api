...
export class UsersService {
    ...
    async create(createUserDto: CreateUserDto): Promise<User> {
        ...
        if (createUserDto.role === Role.CASHIER && createUserDto.branchId) {
            const branch = await this.branchesService.findById(createUserDto.branchId);
        ...
        const user = this.usersRepository.create({
            ...
            branchId: createUserDto.role === Role.CASHIER ? (createUserDto.branchId ?? null) : null
        });
    ...
    async update(id: string, updateUserDto: UpdateUserDto): Promise<User> {
        ...
        if (updateUserDto.role === Role.CASHIER &&
            updateUserDto.branchId !== undefined &&
            updateUserDto.branchId !== null
        ) {
            const branch = await this.branchesService.findById(updateUserDto.branchId);
